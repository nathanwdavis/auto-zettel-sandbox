---
id: '202609042081'
key: divine-simplicity-is-the-question-the-monotheisms-actually-divide-on--202609042081
slug: divine-simplicity-is-the-question-the-monotheisms-actually-divide-on
aliases:
- '202609042081'
type: permanent
title: The monotheisms divide over the scope of simplicity, not over plurality
tags: []
links:
...
but locates the disagreement one step too late.

All three traditions admit internal distinction of *some* kind and then argue
about what kind. What actually separates them is how far the argument from
dependence is allowed to run — how much of what we say about God the denial of
composition is taken to eliminate.

- **Maimonides** runs it furthest. It consumes not only parts but attributes and
  finally number itself: God is wise without the attribute of wisdom, and unity
  is an accident (see [[maimonides-denies-god-has-attributes-at-all-not-merely-that-they-divide-him--202609042075]]).
- **Aquinas** stops it at metaphysical composition, enumerates six kinds, and
  does not reach the persons in the question where he states the doctrine (see
  [[aquinas-argues-simplicity-from-dependence-and-stops-short-of-the-attributes--202609042076]]).
- **The kabbalistic dispute** the base already holds is the same argument at a
  third setting: whether the sefirot are God's essence or His instruments is a
  question about how much distinction the simple One can carry, asked in a
  vocabulary of emanation rather than of substance.

Read this way [[internal-plurality-is-not-what-divides-the-monotheisms--202609011543]]
is right, and can be given a reason it did not have. Plurality is not the
dividing question because every party is trying to satisfy the *same* constraint
— that God not be a composite requiring a composer — and their doctrines of
